...
const buildTaskTemplate = ({ id, title, createdAt, description, assignedUser, status }) => {
  ...
  return `
    <div class="task p-3 m-1" data-id="${id}">
      ...
      <div class="px-2 pb-2 my-2">
        <p class="task__description px-2 rounded-3 border border-white">${description}</p>
        <div class="d-flex flex-column gap-1">
          ...
          <div class="task__status">
            ...
            <select class="form-select form-select-sm task__select w-100 rounded-3 border-white" name="status"
        ...
        <div class="task__buttons d-flex mx-3 gap-3" justify-content-end>
          <button type="button" class="task__button task__button_edit btn border-white d-flex justify-content-center align-items-center gap-2" id="edit-button"
            data-bs-toggle="modal" data-bs-target="#edit-modal" data-role="edit">
          ...
          <button type="button" class="task__button task__button_remove btn border-white d-flex justify-content-center align-items-center gap-2" data-bs-toggle="modal"
            data-bs-target="#delete-modal" id="delete-task-button" data-role="remove-task">
