    ...
    <div class="task p-3" data-id="${id}">
      ...
      <div class="task__footer d-flex">
        ...
        <div class="task__buttons d-flex mx-3">
          <button type="button" class="task__button task__button_edit btn border-white" data-bs-toggle="tooltip"
          ...
          <button type="button" class="task__button task__button_remove btn border-white" data-bs-toggle="tooltip"
